...
#bg image
background = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy,size):
        super().__init__()
        if size == "small":
            self.image = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\small_coin.png")
        elif size == "medium":
            self.image = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\med_coin.png")
        elif size == "large":
            self.image = pygame.image.load(r"C:\Users\user\Desktop\lab1\lab9\big_coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound(r"C:\Users\user\Desktop\lab1\lab9\crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound(r"C:\Users\user\Desktop\lab1\lab9\getcoin.mp3").play()
